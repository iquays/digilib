...
$this->registerJs(
    '$("document").ready(function(){
        $("#tugas-akhir-search2").on("pjax:end", function() {
            $.pjax.reload({container:"#tugas-akhir-index2"});  //Reload GridView
        });
    });'
);
?>

<div class="tugas-akhir-search2">

    <?php \yii\widgets\Pjax::begin(['id' => 'tugas-akhir-search2']) ?>
